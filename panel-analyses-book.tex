...
\caption{\label{tab:unnamed-chunk-42}Table de corrélation entre les variables quantitatives}
\centering
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{DBase}\SpecialCharTok{$}\NormalTok{Destination\_Country }\OtherTok{\textless{}{-}}\NormalTok{ DBase}\SpecialCharTok{$}\NormalTok{Destination\_Country }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{factor}\NormalTok{()}
\NormalTok{DBase}\SpecialCharTok{$}\NormalTok{Destination\_Country }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{levels}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{p\_DF\_aggreg }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{mutate\_all}\NormalTok{(}\ControlFlowTok{function}\NormalTok{(x) \{x}\SpecialCharTok{{-}}\FunctionTok{mean}\NormalTok{(x,}\AttributeTok{na.rm=}\NormalTok{T)\}) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{as.data.frame}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{as.data.frame}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{stargazer}\NormalTok{(}\AttributeTok{type =} \StringTok{"text"}\NormalTok{,}\AttributeTok{omit.summary.stat =} \StringTok{"mean"}\NormalTok{,}\AttributeTok{digits =} \DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{p\_DF\_aggreg }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{group\_by}\NormalTok{(Destination\_Country) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{select}\NormalTok{(Taxes,Weight) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{summarise\_all}\NormalTok{(mean) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{as.data.frame}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{select}\NormalTok{(}\SpecialCharTok{{-}}\NormalTok{Destination\_Country) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{stargazer}\NormalTok{(}\AttributeTok{type=}\StringTok{"text"}\NormalTok{,}\AttributeTok{digits =} \DecValTok{2}\NormalTok{) }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{p\_DF\_aggreg }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{group\_by}\NormalTok{(Destination\_Country) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{select}\NormalTok{(Taxes,Weight) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{mutate\_all}\NormalTok{(}\ControlFlowTok{function}\NormalTok{(x) \{x}\SpecialCharTok{{-}}\FunctionTok{mean}\NormalTok{(x)\}) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{as.data.frame}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{select}\NormalTok{(}\SpecialCharTok{{-}}\NormalTok{Destination\_Country) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{stargazer}\NormalTok{(}\AttributeTok{type =} \StringTok{"text"}\NormalTok{,}\AttributeTok{omit.summary.stat =} \StringTok{"mean"}\NormalTok{,}\AttributeTok{digits =} \DecValTok{2}\NormalTok{)}
\end{Highlighting}
...
Modèle à polaire, considérant les deux éffets
...
Ainsi donc, quand le poids augmente d'une unité, les taxes augmentent de 41,85 unités, pout tous les pays, et à travers le temps. cette augmentation est significativement firrérent de 0

En testant la significativité globale du modèle,

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{plmtest}\NormalTok{(pooling\_model)}
\end{Highlighting}
\end{Shaded}
...
Le test pour le modèle \texttt{pooling} est non significatif vu que le p-value associé au test est suupérieur au seuil de 5\% (0,05). Ainsi donc, npos adoptons l'hupothèse nulle du test selon laquelle le modèle polaire n'est pas significatif.
...
Le coefficient des taxes signifie, que les pays augmentaient leurs importations d'une unitées, chacune, nous aurions une agmentation de 39,687 dollars pour ce pays.
...
\item
  HONG KONG 21758301 dollars de plus
\end{itemize}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ai }\OtherTok{\textless{}{-}} \FunctionTok{fixef}\NormalTok{(within\_model,}\AttributeTok{type =} \StringTok{"dmean"}\NormalTok{)}

\NormalTok{ai }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{as.data.frame}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
##                                                     .
## AFRIQUE DU SUD                            -2984326.03
## ALGERIE                                   -1165271.62
## ALLEMAGNE                                 -1632580.61
## AMERIQUE LATINE                            2202439.71
## GRANDE BRATAGNE                           -3470934.54
## ANGOLA                                   -15589167.27
## ARABIE                                     -142028.25
## ASIE                                         38936.72
## AUSTRALIE                                   285990.29
...
## CHINE                                     21758300.68
## CHYPRE                                     2015623.85
## CONGO BRAZA                                 355028.22
## REP TCHEQUE                                1577815.74
## NA                                        -1030865.82
## EMIRATES ARABES UNIES                      1635013.00
## ESPAGNE                                     358452.36
## FRANCE                                    -3760302.34
## GABON                                       270146.82
## GRECE                                      -167122.77
## HONG KONG                                 14181338.15
## ILE MAURICE                              -18631113.63
## INDE                                       2932397.32
## ITALIE                                    -3579816.54
## JAPON                                       -11074.78
## KENYA                                      -367019.02
## KP - Corée, République Populaire démocra    218970.88
## LUXEMBOURG                                 3908067.60
## MALAISIE                                   9323874.62
## MAROC                                     -3041138.54
## NERLAND                                   -1458943.80
## PAYS BAS                                  -2135869.03
## NIGERIA                                      69469.46
## NOUVELLE ZELANDE                           -964653.67
## OUGANDA                                   -9660163.23
## PANAMA                                     1902251.68
## PHILLIPINE                                  377090.25
## POLOGNE                                    -189313.83
## PORTUGAL                                  -1520165.36
## ROYAUME UNI                               -1520165.36
## RDC                                      -10887866.60
## USA                                       -3702024.25
## RWANDA                                    -2745202.66
## SINGAPOUR                                 -1271537.64
## SUISSE                                    -6428958.73
## SENEGAL                                    -164360.36
## SOMALIE                                     182031.20
## SOUDAN                                      370990.51
## SUD SOUDAN                                -3003470.69
## SUEDE                                     -1129587.86
## Swaziland                                  -975538.34
## TANZANIE                                   -373840.11
## TCHAD                                       127674.41
## THAILANDE                                 -6581130.20
## UNION EUROPEENNE                             86341.53
## ZAMBIE                                    -1561477.21
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{summary}\NormalTok{(ai) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{kable}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\hline
OUGANDA & -9660163.23 & 6259154 & -1.5433657 & 0.1246125\\
\hline
...
\hline
TCHAD & 127674.41 & 18902700 & 0.0067543 & 0.9946189\\
\hline
THAILANDE & -6581130.20 & 9554902 & -0.6887700 & 0.4919125\\
\hline
UNION EUROPEENNE & 86341.53 & 18902832 & 0.0045677 & 0.9963609\\
\hline
...
Pour l'agmentation d'une unité pour le poids des marchandises, ont observe une augmentation des taxes de 38,81 unitées d'un pays à un autre. cela signifie que, si un pays à importé un 1Kg plus qu'un autre, nous observerons une différence de 38,82 dollars pour les taxes.

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{pFtest}\NormalTok{(within\_model,pooling\_model)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{phtest}\NormalTok{(between\_model,within\_model)}
\end{Highlighting}
\end{Shaded}
...
Ce test étant non qignificatif, c'est-à-dire , nous adoptons l'hypothèse nulle : les coefficients du modèle à éffet fixe et ceux du modèle à éffet aléatoire ne sont pas significativement différents. Ainsi donc, nous utiliserons les modèle à éffets aléatoire car celui ci est éfficient.(éficace)

Effet aleatoire

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{re }\OtherTok{\textless{}{-}} \FunctionTok{update}\NormalTok{(pooling\_model,}\AttributeTok{model=}\StringTok{"random"}\NormalTok{,}\AttributeTok{random.method=}\StringTok{"walhus"}\NormalTok{)}
\FunctionTok{summary}\NormalTok{(re)}
\end{Highlighting}
\end{Shaded}
...
\begin{verbatim}
## # A tibble: 439 x 5
##     Year Destination_Country Goods                              Weight      Taxe
##    <dbl> <fct>               <fct>                               <dbl>     <dbl>
##  1  2010 ALLEMAGNE           caféarabica                        1.73e5    3.70e6
##  2  2010 ALLEMAGNE           Minérais et dérivés                1.1 e1    0     
##  3  2010 GRANDE BRATAGNE     caféarabica                        2.58e5    5.91e6
##  4  2010 GRANDE BRATAGNE     Minérais et dérivés                2.06e5    1.75e7
##  5  2010 ANGOLA              Cigarette et papier cigarettes e~  4.03e5    0     
##  6  2010 BELGIQUE            Autres Marchandises                1.75e3    0     
##  7  2010 BELGIQUE            Médicaments et plantes médécinal~  4.60e5    0     
##  8  2010 BELGIQUE            caféarabica                        3.42e5    7.86e6
##  9  2010 BELGIQUE            Minérais et dérivés                1.72e6    1.54e8
## 10  2010 BURUNDI             Autres Marchandises                3.49e3    0     
## # ... with 429 more rows
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Gbase }\OtherTok{\textless{}{-}}\NormalTok{ df }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{pivot\_wider}\NormalTok{(}\AttributeTok{names\_from =}\NormalTok{ Destination\_Country, }\AttributeTok{values\_from =} \FunctionTok{c}\NormalTok{(Taxe,Weight))}
\NormalTok{Gbase }\OtherTok{\textless{}{-}}\NormalTok{  Gbase }\SpecialCharTok{\%\textgreater{}\%}  \FunctionTok{mutate\_all}\NormalTok{(}\SpecialCharTok{\textasciitilde{}}\FunctionTok{replace}\NormalTok{(.,}\FunctionTok{is.na}\NormalTok{(.),}\DecValTok{0}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Gbase  }\OtherTok{\textless{}{-}}\NormalTok{ Gbase  }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{mutate}\NormalTok{(}\AttributeTok{Tax=}\FunctionTok{reduce}\NormalTok{(}\FunctionTok{select}\NormalTok{(.,}\FunctionTok{starts\_with}\NormalTok{(}\StringTok{"Taxe"}\NormalTok{)),}\StringTok{\textasciigrave{}}\AttributeTok{+}\StringTok{\textasciigrave{}}\NormalTok{))}
\NormalTok{Gbase  }\OtherTok{\textless{}{-}}\NormalTok{ Gbase  }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{mutate}\NormalTok{(}\AttributeTok{W=}\FunctionTok{reduce}\NormalTok{(}\FunctionTok{select}\NormalTok{(.,}\FunctionTok{starts\_with}\NormalTok{(}\StringTok{"Weight"}\NormalTok{)),}\StringTok{\textasciigrave{}}\AttributeTok{+}\StringTok{\textasciigrave{}}\NormalTok{))}
\NormalTok{Gbase }\OtherTok{\textless{}{-}}\NormalTok{ Gbase }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{select}\NormalTok{(}\SpecialCharTok{{-}}\FunctionTok{starts\_with}\NormalTok{(}\StringTok{"Taxe"}\NormalTok{),}\SpecialCharTok{{-}}\FunctionTok{starts\_with}\NormalTok{(}\StringTok{"Weight"}\NormalTok{))}
\NormalTok{Gbase }\OtherTok{\textless{}{-}}\NormalTok{ Gbase }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{rename}\NormalTok{(}\StringTok{"Taxes"}\OtherTok{=}\StringTok{"Tax"}\NormalTok{,}\StringTok{"Weight"}\OtherTok{=}\StringTok{"W"}\NormalTok{)}

\NormalTok{Gbase }\OtherTok{\textless{}{-}}\NormalTok{ Gbase }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{pdata.frame}\NormalTok{(}\AttributeTok{index =} \FunctionTok{c}\NormalTok{(}\StringTok{"Goods"}\NormalTok{,}\StringTok{"Year"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{phtest}\NormalTok{(between\_model1,within\_model1) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{tidy}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
