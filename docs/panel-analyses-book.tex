...
\$Z\_\mu Z\^{}\{'\}\emph{\mu = I\_N \otimes J\_T \$ where \$ JT \$
is a matrix of ones of dimension T and \$ P = Zμ(Z\^{}\{`\}\emph{\mu Z}\mu)\^{}\{−1\} Z\^{}\{'\}}\mu  \$, the projectionmatrix on \$ Z\_\mu \$ , reduces to IN ⊗ J¯T where \$J¯T = JT /T \$. P is a matrix which averages the observation across time for each individual, and Q = INT − P is a matrix which obtains
...
\hypertarget{manque-3-lignes-et-2-uxe9quations}{%
\section{Manque 3 lignes et 2 équations}\label{manque-3-lignes-et-2-uxe9quations}}
